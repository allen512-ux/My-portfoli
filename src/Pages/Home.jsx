...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/allen512-ux" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/allen-s-sajan-bb45b0291/" },
  { icon: Instagram, link: "https://www.instagram.com/its.allensajan/?igsh=MWFuMDZuZjVta3N6aw%3D%3D#" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  A dedicated Full Stack Developer with a focus on building dynamic web applications using the MERN stack
                </p>
