        ...
        >
          ...
          <div className="relative min-h-screen flex items-center justify-center px-4">
            <div className="w-full max-w-4xl mx-auto">
              ...
              {/* Right Arrow Icon with AOS animation */}
              <motion.div
                className="flex justify-center mt-6"
                data-aos="fade-up"
                data-aos-delay="1200" // Adjust delay if needed
              >
                <ArrowRight className="w-8 h-8 sm:w-10 sm:h-10 text-indigo-600 cursor-pointer hover:text-purple-600 transition-colors duration-300" />
              </motion.div>
            </div>
          </div>
        </motion.div>
